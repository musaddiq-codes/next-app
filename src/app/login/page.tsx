...
export default function LoginPage() {
    ...
    const onLogin = async () => {
        try {
            setLoading(true);
            const response = await axios.post("/apis/users/login", user);
...
//             <button onClick={onLogin} className="p-2 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-900">Signin here</button>
//             <Link href="/signup">Visit Signup Page</Link>
//         </div>
//     )
// }
